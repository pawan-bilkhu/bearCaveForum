...
if (isset($_SESSION['user']) && $_SESSION['user'] === "admin"){
    ...
    echo "<div class=\"dropdown\"><button onclick=\"profile()\"><img class=\"PP\" src=\"../images/user/".$image."\" alt=\"".$_SESSION['user']."\" width=\"30px\" height=\"30px\" style=\"border-radius:15px\"></button>";
    echo "<div class=\"dropdown-content\"><a href=\"profile.php\">My Account</a><a href=\"findUser.php\">Find User</a><a href=\"logout.php\">Logout</a></div></div>";
}
